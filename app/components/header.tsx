            ...
            <>
                <header className="bg-slate-200">
                    <nav className="flex items-center justify-between p-4 lg:px-8" aria-label="Global">
                        <Image width={35} height={35} src={'../logo.svg'} alt={'logo'}></Image>
                        <div className="lg:flex hidden font-sans gap-8">
                        ...
                        <button className='text-white lg:flex hidden bg-[#4f46e5] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800'>Login</button>
                        {/* For small */}
                        <div className="visible lg:hidden">
                            ...
                            <aside id="default-sidebar" className=" {isHeader? fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0" aria-label="Sidebar">
