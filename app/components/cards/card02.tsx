    ...
    return (
        <>
            <div className="rounded-md shadow-md bg-[#151030] dark:text-gray-100">
                ...
                <img src="/images/nextjs.png" alt="" className="object-cover object-center w-full h-[140px] dark:bg-gray-500" />
                <div className="p-3">
                    ...
                    <div className="flex flex-wrap items-center pt-3 pb-1">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm ml-[15px]">Liked by
                                <span className="font-semibold"> Daniyal Nagori </span>and
                    ...
                    <div className="space-y-3">
                        ...
                        <input type="text" placeholder="Add a comment..." className="w-full py-0.5 dark:bg-transparent border-none rounded-sm p-1 text-sm dark:text-gray-100" />
                    </div>
                </div>
            </div>
        </>
